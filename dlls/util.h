...
#ifndef CLIENT_DLL
  #define MAX_PLAYERS gpGlobals->maxClients
#else
...
#define		BLOOD_COLOR_YELLOW		(BYTE)247
#define		BLOOD_COLOR_GREEN		(BYTE)247
...
#define VEC_VIEW			Vector( 0, 0, 21 )

#define VEC_DUCK_HULL_MIN	Vector(-16, -16, -18 )
#define VEC_DUCK_HULL_MAX	Vector( 16,  16,  18)
#define VEC_DUCK_VIEW		Vector( 0, 0, 8 )
...
#define EMIT_SOUND_ARRAY_DYN( chan, array ) EMIT_SOUND_DYN ( ENT(pev), chan , array [ RANDOM_LONG(0,ARRAYSIZE( array )-1) ], 1.0, ATTN_NORM, 0, RANDOM_LONG(95,105) );
...
void EnableAll( const char *name, char *target = NULL );
