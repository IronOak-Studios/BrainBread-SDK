...
public:
  ...
  ~CBaseEntity( )
  {
	...
	virtual void	GiveExp( float value, bool load = false ) { return; }
	float exp;
	bool expLoaded;
	// + Spinator
	virtual void	ReSpawn( ) { return; }
	// - Spinator
