...
// Client connection/disconnection
	...
	virtual BOOL InitHUD( CBasePlayer *pl ) = 0;		// the client dll is ready for updating
...
// Client connection/disconnection
	...
	virtual BOOL InitHUD( CBasePlayer *pl );		// the client dll is ready for updating
