...
extern CBaseEntity				*g_pLastSpawnSynd;
extern CBaseEntity				*g_pLastSpawnSec;
...
void CGlobalState::EntityUpdate( string_t globalname, string_t mapname )
{
	...
	if ( pEnt )
	{
		...
		pEnt->levelName[sizeof(pEnt->levelName) - 1] = '\0';
	}
}
...
{
	g_pLastSpawn = NULL;
	g_pLastSpawnSynd = NULL;
	g_pLastSpawnSec = NULL;
...
// sounds used from C physics code
	...
	//}
	PRECACHE_MODEL( "models/gibs/head1.mdl" );
	//PRECACHE_MODEL( "models/gibs/head2.mdl" );
	PRECACHE_MODEL( "models/gibs/head3.mdl" );
	PRECACHE_MODEL( "models/gibs/upper.mdl" );
	PRECACHE_MODEL( "models/gibs/arm1.mdl" );
	PRECACHE_MODEL( "models/gibs/arm2.mdl" );
...
void CWorld :: KeyValue( KeyValueData *pkvd )
{
	...
	else if ( FStrEq(pkvd->szKeyName, "gamescenario") )
	{
		pkvd->fHandled = TRUE;
		g_iPERules = atoi( pkvd->szValue );
	}
	else
		CBaseEntity::KeyValue( pkvd );
}
