...
LINK_ENTITY_TO_CLASS( monster_hgrunt_shotgun, CHGrunt );
LINK_ENTITY_TO_CLASS( monster_human_grunt, CHGrunt );
//LINK_ENTITY_TO_CLASS( monster_barney, CHGrunt );
...
void CHGrunt :: Shotgun ( void )
{
	...
	FireBullets(gSkillData.hgruntShotgunPellets, vecShootOrigin, vecShootDir, VECTOR_CONE_15DEGREES, 2048, BULLET_PLAYER_MP5, 0 ); // shoot +-7.5 degrees
...
void CHGrunt::Spawn()
{
	...
	if( FClassnameIs( pev, "monster_hgrunt_shotgun" ) )
