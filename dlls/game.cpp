...
cvar_t	scoreleft	= {"mp_scoreleft","0" , FCVAR_SERVER | FCVAR_UNLOGGED };	  // "      "
...
cvar_t	gameplay	= {"sv_gameplay", "normal", FCVAR_SERVER };
cvar_t	roundtime	= {"sv_roundtimelimit", "1000", FCVAR_SERVER };
cvar_t	rounddelay	= {"sv_rounddelay", "8", FCVAR_SERVER };

cvar_t	playerinfofile	= {"sv_playerinfofile", "players.lvl", FCVAR_SERVER };
...
cvar_t	autoteam	= {"sv_autoteambalance", "0", FCVAR_SERVER };
cvar_t	mapvote		= {"sv_mapvote", "1", FCVAR_SERVER };
cvar_t	varvote		= {"sv_varvote", "0", FCVAR_SERVER };
cvar_t	peversion	= {"bbversion", "BrainBread v1.3.37", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	recoilratio	= {"mp_recoilratio", "1.00", FCVAR_SERVER };
cvar_t	speedratio	= {"mp_speedratio", "0.8", FCVAR_SERVER };
cvar_t	dmgratio	= {"mp_dmgratio", "0.65", FCVAR_SERVER };
cvar_t	setsyn		= {"setsyn", "0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	setsec		= {"setsec", "0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	plkill		= {"plkill", "0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	restartround = {"sv_restartround", "0", FCVAR_SERVER | FCVAR_UNLOGGED };
cvar_t	teamplay	= {"mp_teamplay", "0", FCVAR_SERVER };
cvar_t	teamscorelimit	= {"mp_teamscorelimit", "0", FCVAR_SERVER };
...
cvar_t  mp_chattime = {"mp_chattime","15", FCVAR_SERVER };
...
void PEPlKill( )
{
	plkill.value = atof(CMD_ARGV( 1 ));
}
void PESetSec( )
{
	setsec.value = atof(CMD_ARGV( 1 ));
}
void PESetSyn( )
{
	setsyn.value = atof(CMD_ARGV( 1 ));
}

void GameDLLInit( void )
{
	ADD_SERVER_CMD( "plkill", PEPlKill );
	ADD_SERVER_CMD( "setsec", PESetSec );
	ADD_SERVER_CMD( "setsyn", PESetSyn );
	// Register cvars here:
...
//	CVAR_REGISTER (&gameplay);
	...
	CVAR_REGISTER (&rounddelay);

	CVAR_REGISTER (&playerinfofile);
...
//	CVAR_REGISTER (&autoteam);
	CVAR_REGISTER (&mapvote);
	CVAR_REGISTER (&varvote);
	CVAR_REGISTER (&peversion);
	CVAR_REGISTER (&recoilratio);
	CVAR_REGISTER (&speedratio);
	CVAR_REGISTER (&dmgratio);
//	CVAR_REGISTER (&setsyn);
//	CVAR_REGISTER (&setsec);
//	CVAR_REGISTER (&plkill);
	CVAR_REGISTER (&restartround);
	CVAR_REGISTER (&teamplay);
	CVAR_REGISTER (&teamscorelimit);
