...
LINK_ENTITY_TO_CLASS( bb_spawn_player, CPointEntity );
LINK_ENTITY_TO_CLASS( bb_zombie_player, CPointEntity );
//LINK_ENTITY_TO_CLASS( pe_spawn_syndicate, CPointEntity );
...
void CBaseEntity :: SUB_Remove( void )
{
	...
	{
		ALERT( at_aiconsole, "SUB_Remove CALLLEEEDDD ON MONSTER ZOMBIE!!!!!!!!11111111\n");
	}
