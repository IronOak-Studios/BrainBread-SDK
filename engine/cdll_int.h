...
{
	// sprite handlers
	cldll::HSPRITE				( *pfnSPR_Load )			( const char *szPicName );
	int							( *pfnSPR_Frames )			( cldll::HSPRITE hPic );
	int							( *pfnSPR_Height )			( cldll::HSPRITE hPic, int frame );
	int							( *pfnSPR_Width )			( cldll::HSPRITE hPic, int frame );
	void						( *pfnSPR_Set )				( cldll::HSPRITE hPic, int r, int g, int b );
	...
	void						( *pfnSetCrosshair )		( cldll::HSPRITE hspr, wrect_t rc, int r, int g, int b );
...
// Added for user input processing
	...
	const struct model_s *		( *GetSpritePointer )		( cldll::HSPRITE hSprite );
