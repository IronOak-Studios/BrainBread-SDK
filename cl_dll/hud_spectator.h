...
public:
	...
	bool AddOverviewEntityToList( cldll::HSPRITE sprite, cl_entity_t * ent, double killTime);
...
private:
	...
	cldll::HSPRITE		m_hsprPlayerBlue;
	cldll::HSPRITE		m_hsprPlayerRed;
	cldll::HSPRITE		m_hsprPlayer;
	cldll::HSPRITE		m_hsprCamera;
	cldll::HSPRITE		m_hsprPlayerDead;
	cldll::HSPRITE		m_hsprViewcone;
	cldll::HSPRITE		m_hsprUnkownMap;
	cldll::HSPRITE		m_hsprBeam;
	cldll::HSPRITE		m_hCrosshair;
