...
public:
	...
	int MsgFunc_Class( const char *pszName, int iSize, void *pbuf );
...
public:
  ...
  CImageLabel			*m_pModelImages[6];
  CMenuHandler_StringCommandWatch *m_pWatch[3];
...
class CEquip : public CMenuPanel
{
public:
	CEquip(int iTrans, int iRemoveMe, int x, int y, int wide, int tall);
private:
	CommandButton		*m_pBt1;
	CommandButton		*m_pBt2;
	CommandButton		*m_pBt3;
	CommandButton		*m_pBt4;
	CommandButton		*m_pBt5;
	CTransparentPanel	*m_pPanel1;
	CTransparentPanel	*m_pPanel2;
	CTransparentPanel	*m_pPanel3;
	CTransparentPanel	*m_pPanel4;
	CTransparentPanel	*m_pPanel5;
	//Label				*m_pInfoCancel;
	//Border				*m_pCntBorder;
