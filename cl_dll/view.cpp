...
{	
	...
	viewent->angles[PITCH]  += (float)g_iShots/50.0;
...
void V_CalcNormalRefdef ( struct ref_params_s *pparams )
{
	...
	if ( g_iUser1 == OBS_IN_EYE || gEngfuncs.IsSpectateOnly() )
	{
	...
	//ev_punchangle[0] = -g_fPunch * (float)g_iShots;
	//pparams->punchangle[0] = -g_fPunch * (float)g_iShots;
...
void V_GetInEyePos(int target, float * origin, float * angles )
{
	...
	if ( ent->curstate.solid == SOLID_NOT )
	{
		...
		origin[2]+= 21; // DEFAULT_VIEWHEIGHT
}
...
int V_FindViewModelByWeaponModel(int weaponindex)
{
	...
	static const char * modelmap[][2] =	{
		...
		{ "models/beretta/p_beretta.mdl",		"models/beretta/v_beretta.mdl"		},
		{ "models/beretta/p_beretta_a.mdl",		"models/beretta/v_beretta_a.mdl"	},
		{ "models/deagle/p_deagle.mdl",			"models/deagle/v_deagle.mdl"		},
		{ "models/glock/p_glock.mdl",			"models/glock/v_glock.mdl"			},
		{ "models/glock/p_glock_auto.mdl",		"models/glock/v_glock_auto.mdl"		},
		{ "models/glock/p_glock_auto_a.mdl",	"models/glock/v_glock_auto_a.mdl"	},
		{ "models/canister/p_canister.mdl",		"models/canister/v_canister.mdl"		},
		{ "models/knife/p_knife.mdl",			"models/knife/v_knife.mdl"			},
		{ "models/m16/p_m16.mdl",				"models/m16/v_m16.mdl"				},
		{ "models/microuzi/p_microuzi.mdl",		"models/microuzi/v_microuzi.mdl"	},
		{ "models/microuzi/p_microuzi_a.mdl",	"models/microuzi/v_microuzi_a.mdl"	},
		{ "models/minigun/p_minigun.mdl",		"models/minigun/v_minigun.mdl"		},
		{ "models/mp5_10/p_mp5_10.mdl",			"models/mp5_10/v_mp5_10.mdl"		},
		{ "models/mp5sd/p_mp5sd.mdl",			"models/mp5sd/v_mp5sd.mdl"			},
		{ "models/p225/p_p225.mdl",				"models/p225/v_p225.mdl"			},
		{ "models/p226/p_p226.mdl",				"models/p226/v_p226.mdl"			},
		{ "models/seburocx/p_seburocx.mdl",		"models/seburocx/v_seburocx.mdl"	},
		{ "models/44sw/p_44sw.mdl",			"models/44sw/v_44sw.mdl"		},
		{ "models/sawed/p_sawed.mdl",			"models/sawed/v_sawed.mdl"		},
		{ "models/winchester/p_winchester.mdl",			"models/winchester/v_winchester.mdl"		},
		{ "models/tavor/p_tavor.mdl",			"models/tavor/v_tavor.mdl"			},
		{ "models/usp/p_usp.mdl",				"models/usp/v_usp.mdl"				},
		{ "models/uspmp/p_uspmp.mdl",			"models/uspmp/v_uspmp.mdl"			},
		{ "models/hand/p_hand.mdl",				"models/hand/v_hand.mdl"			},
		NULL };
...
#if 0
	if( ( g_iUser1 && /*( gHUD.m_Intro.m_iFlags & HUD_ACTIVE ) &&*/ ( gHUD.m_iHideHUDDisplay & HIDEHUD_HEALTH ) ) /*|| ( ( gHUD.m_PETeam.m_iFlags & HUD_ACTIVE ) && g_iUser1 )*/ )
	{
		screenfade_t sf;
...
void V_Init (void)
{
	...
	cl_bobtilt			= gEngfuncs.pfnRegisterVariable( "cl_bobtilt","1", FCVAR_ARCHIVE );
